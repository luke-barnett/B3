...
namespace IndiaTango.Tests
{
    ...
    class CalibrationTest
    {
        ...
        {
			_ds.Sensors[0].AddState(_ds.Sensors[0].CurrentState.Calibrate(_ds.StartTimeStamp, _ds.EndTimeStamp, 20, 15, 119.6f, 114.6f));
		...
		{
			_ds.Sensors[2].AddState(_ds.Sensors[2].CurrentState.Calibrate(_ds.StartTimeStamp, new DateTime(2009,1,9,16,0,0), 20, 15, 30f, 5f));
